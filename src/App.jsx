...
function App() {
  ...
  useEffect(() => {
    // console.log('Componente listo o la cantidad cambió');
    ...
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
        ...
        <input
         ...
         <p className="text-center my-10 text-5xl font-extrabold text-indigo-600">
          ...
          <select 
            className="mt-5 w-full bg p-2 bg-white border border-gray-300 rounded-lg text-center text-xl font-bold text-gray-500"
            value={meses}
